...
from src.comm_utils.prints import pad_num, print_log_message, print_warning_message
...
def extract_annos(anno_path: str, vol_idxes: List, label_reg: str, num_frame: int = 18):
    """Return PASCAL_VOC type bounding boxes.[z, x_min, y_min, x_max, y_max, iskey] """
    raw_labels = loadmat(anno_path)['neuron_boxes']
